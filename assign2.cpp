//============================================================
// STUDENT NAME: Michael Noven	
// MATRIC NO.  : A0146876M
// NUS EMAIL   : e0011105@u.nus.edu
// COMMENTS TO GRADER:
...
//-----------------------------------------------------------------------------
    ...
    GLenum outputFBOAttachement = GL_COLOR_ATTACHMENT0_EXT; // texA
    ...
    //---------------------------------------------------------
		...
		inputTextureUnit = inputTextureUnit ? 0 : 1;
		outputFBOAttachement = outputFBOAttachement == GL_COLOR_ATTACHMENT0_EXT ? GL_COLOR_ATTACHMENT1_EXT : GL_COLOR_ATTACHMENT0_EXT;
		
		//std::cout << "inputTexture" << inputTextureUnit << std::endl; // 1
	    //std::cout << "outputFBOAttachement   " << outputFBOAttachement << std::endl; // 36064
		//std::cout << "GL_COLOR_ATTACHMENT1_EXT   " << GL_COLOR_ATTACHMENT1_EXT << std::endl; // 36065
...
// For debugging
static void displayOutputArray(const float A[], const int numElems){

	for (int i = 10000; i < numElems - 1; i++){
...
//-----------------------------------------------------------------------------
	...
	//displayOutputArray(GPU_outputArray, numInputElems); // added for debug-mode
